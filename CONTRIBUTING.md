...
You want to contribute to pony-matrix-clientapi? Awesome.
...
First of all please [search existing issues](https://github.com/redvers/pony-matrix-clientapi/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/redvers/pony-matrix-clientapi/issues/new).
